---
title: "_Rana sierrae_ at Dusy Basin"
author: "Laetitia Wilkins"
date: "May 10 2019 in Munich"
...
This [script](https://github.com/megaptera-helvetiae/DusyBasin/blob/master/Scripts_summaryStats/r_code_frogs_summaryStats_lgew.Rmd) assumes you have a working directory in your home directory. Here, this directory is called "/DusyBasin"

All the input files for this script here are in "~/DusyBasin/Input_summaryStats/"
or live: https://github.com/megaptera-helvetiae/DusyBasin/tree/master/Input_summaryStats
...
# Also, learn about how to use secrets in R here: https://cran.r-project.org/web/packages/httr/vignettes/secrets.html

# And this: https://cran.r-project.org/web/packages/googlesheets/vignettes/managing-auth-tokens.html
...
## Figures 3 and 4 were done using code in another [script](https://github.com/megaptera-helvetiae/DusyBasin/tree/master/Scripts_unmarked) by Zack Steel!!!
...
## Now the code for Table 1

```{r, warning=FALSE, message=FALSE, eval=FALSE}
setwd("/")
datab<-read.delim("sc.orig.rev.txt", header=T)
# This data file is in the main directory for data on Git repository (Data).
